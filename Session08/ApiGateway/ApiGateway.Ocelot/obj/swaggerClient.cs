...
namespace ApiGateway.Ocelot
{
    ...
    public partial class swaggerClient 
    {
        ...
        public System.Threading.Tasks.Task<Person> PersonAsync(int id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Person> PersonAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
