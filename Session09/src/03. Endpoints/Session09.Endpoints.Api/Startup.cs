...
namespace Session09.Endpoints.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<CreateNewPersonCommandHandler>();
            services.AddScoped<IPersonCommandRepository, PersonCommandRepository>();
            services.AddDbContextPool<Session09DbContext>(c => c.UseSqlServer(Configuration.GetConnectionString("PersonDb_ConnectionString")));
